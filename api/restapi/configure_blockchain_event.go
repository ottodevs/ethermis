...
func configureFlags(api *operations.BlockchainEventAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.BlockchainEventAPI) http.Handler {
	...
	api.RegistrationHandler = operations.RegistrationHandlerFunc(Register)
